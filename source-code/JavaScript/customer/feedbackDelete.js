class DeleteFeedbackForm {
  ...
  clearInputField() {
    document.getElementById("DeleteFeedback_ID").value = "";
    document.getElementById("DeleteFeedback_Confirmation").value = "";
  }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch(
    "/Coolant/source-code/Controller/customerController_Feedback.php?fetch_Feedback=true"
  )
